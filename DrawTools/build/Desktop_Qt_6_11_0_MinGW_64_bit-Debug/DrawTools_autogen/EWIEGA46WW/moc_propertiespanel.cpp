...
template <> constexpr inline auto PropertiesPanel::qt_create_metaobjectdata<qt_meta_tag_ZN15PropertiesPanelE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'onModeChanged'
        QtMocHelpers::SlotData<void(DiagramScene::Mode)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        ...
        // Slot 'onShapePropertyChanged'
        QtMocHelpers::SlotData<void()>(9, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onTextPropertyChanged'
...
void PropertiesPanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onModeChanged((*reinterpret_cast<std::add_pointer_t<DiagramScene::Mode>>(_a[1]))); break;
        case 1: _t->onSelectionChanged(); break;
        case 2: _t->choosePenColor(); break;
        case 3: _t->chooseFillColor(); break;
        case 4: _t->chooseTextColor(); break;
        case 5: _t->onShapePropertyChanged(); break;
        case 6: _t->onTextPropertyChanged(); break;
        default: ;
        }
    }
}
